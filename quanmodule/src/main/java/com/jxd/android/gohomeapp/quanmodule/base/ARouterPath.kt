 ...
 * @ClassName:      ARouterPath
 * @Description:     java类作用描述
 * @Author:         jinxiangdong
 * @CreateDate:     2019/1/2 11:11
 * @UpdateUser:     jinxiangdong
 * @UpdateDate:     2019/1/2 11:11
 * @UpdateRemark:   更新说明
 * @Version:        1.0
 */
object ARouterPath {

    const val AppActivityIndexPath="/app/activity/index"

    //商城首页路径
    const val QuanActivityIndexPath ="/quanmodule/activity/index"
    //推荐列表路径
    const val QuanRecommandPath="/quanmodule/recommand"
    //商城首页fragment路径
    ...
    const val QuanFragmentGoodsDetailPath="/quanmodule/fragment/goodsdetail"

    const val QuanFragmentCategoryPath="/quanmodule/fragment/category"

    const val QuanFragmentTabPath= "/quanmodule/fragment/tab"

    const val QuanFragmentGoodsSharePath="/quanmodule/fragment/goodsshare"
    ...
    const val QuanFragmentCouponListPath="/quanmodule/fragment/couponlist"
}