...
object RetrofitManager {
    ...
    private fun provideRetroft( baseUrl : String = Constants.APIBaseURL , okHttpClient: OkHttpClient?,
    ...
    private fun getRetrofit():Retrofit?{
        if(retrofit==null) retrofit =  provideRetroft( Constants.APIBaseURL , provideOkHttpClient(provideHeaderIntercepter()) ,
