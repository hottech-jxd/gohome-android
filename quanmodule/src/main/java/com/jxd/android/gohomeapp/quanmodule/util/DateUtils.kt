...
object DateUtils {
    ...
    val DATA_FORMAT2="yyyy-MM-dd'T'HH:mm:ss.SSS"
    ...
    fun formatDateByZone(currentTime: Long? , timeZone: TimeZone ): String {
        var format: DateFormat? = null
        try {

           //var t =  Date(currentTime , timeZone)
    ...
    fun toDate(str: String, formatStr: String ,  timeZone: TimeZone): Long {
        var format: DateFormat?
