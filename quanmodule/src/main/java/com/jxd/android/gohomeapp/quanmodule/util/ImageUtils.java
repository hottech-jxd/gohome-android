...
package com.jxd.android.gohomeapp.quanmodule.util;
...
public final class ImageUtils {
     ...
     * @return bitmap
     */
    public static Bitmap getBitmap(Application application , @DrawableRes final int resId) {
     ...
     */
    public static Bitmap fastBlur(Application application , final Bitmap src,
                                  @FloatRange(
        ...
        return fastBlur(application , src, scale, radius, false);
    }
     ...
     * @return the blur bitmap
     */
    public static Bitmap fastBlur(Application application ,
                                  final Bitmap src,
                                  @FloatRange(
                                          from = 0, to = 1, fromInclusive = false
                                  ) final float scale,
    ...
    public static Bitmap renderScriptBlur(Application application ,
                                            final Bitmap src,
                                          @FloatRange(
                                                  from = 0, to = 25, fromInclusive = false
                                          ) final float radius) {
     ...
     */
    @RequiresApi(Build.VERSION_CODES.JELLY_BEAN_MR1)
    public static Bitmap renderScriptBlur(Application application , final Bitmap src,
                                          @FloatRange(
                                                  from = 0, to = 25, fromInclusive = false
                                          ) final float radius,
                                          final boolean recycle) {
    ...
    public static Bitmap mergeBitmap(Bitmap bitmap1, Bitmap bitmap2){
        Integer w = bitmap1.getWidth();
        Integer h = bitmap1.getHeight() + bitmap2.getHeight();

        Bitmap bitmap3 = Bitmap.createBitmap( w, h , bitmap1.getConfig());
        Canvas canvas = new Canvas(bitmap3);
        canvas.drawBitmap(bitmap2, new Matrix(), null);
        canvas.drawBitmap(bitmap1, 0, bitmap2.getHeight() , null);  //120、350为bitmap2写入点的x、y坐标
